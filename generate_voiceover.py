...
Run this BEFORE Build_video.py. It writes ./voiceover.wav. Build_video.py's
attach_voiceover() picks that file up automatically and proportionally
scales every scene's duration so the total video length matches the real
narration length exactly.
...
OUTPUT_PATH = "voiceover.wav"  # must match Build_video.py's VOICEOVER_PATH
SAMPLE_RATE = 24000
CHANNELS = 1
SAMPLE_WIDTH = 2               # 16-bit PCM

MAX_CHUNK_CHARS = 6000         # stays safely under Gemini's ~8,000 char input limit
MAX_RETRIES = 3
